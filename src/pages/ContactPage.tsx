...
const QUICK = [
  { svgIcon: WA_SVG,  icon: null, label: 'WhatsApp', value: '+91 89812 56860', sub: 'Usually replies in minutes', color: '#25D366', bg: '#DCFCE7', href: 'https://wa.me/918981256860' },
  { svgIcon: null, icon: Phone, label: 'Call Us',  value: '+91 89812 56860', sub: 'Mon–Sat, 9 AM – 7 PM IST', color: '#007AFF', bg: '#EBF5FF', href: 'tel:+918981256860' },
...
const INFO = [
  ...
  { icon: Phone,   color: '#9552E0', bg: '#F1E6FF', label: 'Phone',         lines: ['+91 89812 56860'] },
...
const SOCIALS = [
  ...
  {
    label: 'WhatsApp', href: 'https://wa.me/918981256860', color: '#25D366', bg: '#DCFCE7', shadow: 'rgba(37,211,102,0.3)',
    viewBox: '0 0 24 24',
...
export default function ContactPage() {
  ...
  return (
    <Layout>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(260px,1fr))', gap:'20px' }}>
            {QUICK.map((q, i) => (
              <motion.a key={q.label} href={q.href} target={q.href.startsWith('http') ? '_blank' : undefined}
                ...
                {...fadeUp(i * 0.08)}
                style={{ display:'flex', alignItems:'center', gap:'16px', background:'#fff', border:'1.5px solid #E5E7EB', borderRadius:'16px', padding:'24px 20px', textDecoration:'none', boxShadow:'0 4px 12px rgba(0,0,0,0.05)' }}
              >
      ...
      {/* ── MAIN: INFO + FORM ─────────────────────────────────────────────────── */}
      <section style={{ background:'linear-gradient(180deg,#F0F7FF 0%,#fff 100%)', padding:'56px 24px', fontFamily:font }}>
        <div style={{ maxWidth:'1060px', margin:'0 auto' }}>
          <div className="ct-main-grid" style={{ display:'grid', gridTemplateColumns:'1fr 1.4fr', gap:'40px', alignItems:'stretch' }}>
            ...
            <motion.div {...fadeUp()} style={{ display:'flex', flexDirection:'column' }}>
              <div style={{ background:'#fff', borderRadius:'16px', border:'1.5px solid #E5E7EB', boxShadow:'0 6px 24px rgba(0,0,0,0.07)', overflow:'hidden', flex:1, display:'flex', flexDirection:'column' }}>

                {/* Top banner */}
                <div style={{ background:'linear-gradient(135deg,#001F5B,#0043C4)', padding:'28px 28px 24px' }}>
                  <h2 style={{ fontSize:'24px', fontWeight:800, color:'#fff', margin:'0 0 6px' }}>Contact Information</h2>
            ...
            <motion.div {...fadeUp(0.1)} style={{ display:'flex', flexDirection:'column' }}>
              <div style={{ background:'#fff', borderRadius:'16px', border:'1.5px solid #E5E7EB', boxShadow:'0 8px 40px rgba(0,0,0,0.08)', padding:'24px 20px', flex:1, display:'flex', flexDirection:'column' }}>
                <h2 style={{ fontSize:'24px', fontWeight:800, color:'#111827', margin:'0 0 6px' }}>Send us a Message</h2>
